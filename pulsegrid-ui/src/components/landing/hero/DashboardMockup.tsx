export default function DashboardMockup() {
  return (
    <div className="relative w-full max-w-[820px] mx-auto h-auto px-2 md:px-0">

      <div className="bg-white rounded-[32px] shadow-[0_25px_60px_rgba(0,0,0,0.08)] border border-slate-100 overflow-hidden">

        <div className="grid grid-cols-1 md:grid-cols-[160px_1fr] min-h-[430px]">

          {/* Desktop Sidebar */}

          <div className="hidden md:block bg-gradient-to-b from-[#02122D] to-[#062A5F] text-white p-5">
          ...
          <div>
            ...
            <div className="md:hidden bg-gradient-to-r from-[#02122D] to-[#062A5F] text-white p-4">
